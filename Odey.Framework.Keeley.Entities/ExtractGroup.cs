...
namespace Odey.Framework.Keeley.Entities
{
    ...
    public partial class ExtractGroup: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<ExtractGroupItem> ExtractGroupItems
        {
            get
            {
                if (_extractGroupItems == null)
                {
                    _extractGroupItems = new TrackableCollection<ExtractGroupItem>();
                    _extractGroupItems.CollectionChanged += FixupExtractGroupItems;
                }
                return _extractGroupItems;
            }
            set
            {
                if (!ReferenceEquals(_extractGroupItems, value))
                {
                    ...
                    _extractGroupItems = value;
                    if (_extractGroupItems != null)
                    {
                        _extractGroupItems.CollectionChanged += FixupExtractGroupItems;
                    }
                    OnNavigationPropertyChanged("ExtractGroupItems");
                }
            }
        }
        private TrackableCollection<ExtractGroupItem> _extractGroupItems;
        ...
        {
            ExtractGroupItems.Clear();
        }

        #endregion
        #region Association Fixup
    
        private void FixupExtractGroupItems(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (ExtractGroupItem item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("ExtractGroupItems", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (ExtractGroupItem item in e.OldItems)
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("ExtractGroupItems", item);
                    }
                }
            }
        }
