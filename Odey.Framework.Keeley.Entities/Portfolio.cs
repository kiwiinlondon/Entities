...
namespace Odey.Framework.Keeley.Entities
{
    ...
    public partial class Portfolio: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public decimal RealisedTotalPNL
        {	
    		
            get { return _realisedTotalPNL; }
            set
            {
                if (_realisedTotalPNL != value)
                {
                    _realisedTotalPNL = value;
                    OnPropertyChanged("RealisedTotalPNL");
                }
            }
        }
        private decimal _realisedTotalPNL;
        [DataMember]
        public decimal UnRealisedTotalPNL
        {	
    		
            get { return _unRealisedTotalPNL; }
            set
            {
                if (_unRealisedTotalPNL != value)
                {
                    _unRealisedTotalPNL = value;
                    OnPropertyChanged("UnRealisedTotalPNL");
                }
            }
        }
        private decimal _unRealisedTotalPNL;
        [DataMember]
