...
namespace Odey.Framework.Keeley.Entities
{
    ...
    public partial class Industry: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        {	
            ...
            set
            {
                if (_industryID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'IndustryID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _industryID = value;
        ...
        [DataMember]
        public Nullable<int> ParentIndustryID
        {	
    		
            get { return _parentIndustryID; }
            set
            {
                if (_parentIndustryID != value)
                {
                    ChangeTracker.RecordOriginalValue("ParentIndustryID", _parentIndustryID);
                    _parentIndustryID = value;
                    OnPropertyChanged("ParentIndustryID");
                }
            }
        }
        private Nullable<int> _parentIndustryID;
        [DataMember]
